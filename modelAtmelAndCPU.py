...
def Model(radio = 'CC1200', txPower = 10):
    ...
    # TsTxOffset       = 200 / 32768.0 * 1000000   # 4000us
    # TsTxAckDelay     = 140 / 32768.0 * 1000000   # 4606us
    # TsLongGT         =  86 / 32768.0 * 1000000   # 1300us
...
def printModelValues(model):
    ...
    print('Joule:')
    print('        TxDataRxAck: ' + str(VOLTS*(model(SlotType.TxDataRxAck, PACKET_LENGTH)/1000000)) + ' J')
    print('        RxDataTxAck: ' + str(VOLTS*(model(SlotType.RxDataTxAck, PACKET_LENGTH)/1000000)) + ' J')
    print('        TxData: ' + str(VOLTS*(model(SlotType.TxData, PACKET_LENGTH)/1000000)) + ' J')
    print('        RxData: ' + str(VOLTS*(model(SlotType.RxData, PACKET_LENGTH)/1000000)) + ' J')
    print('        RxIdle: ' + str(VOLTS*(model(SlotType.RxIdle, PACKET_LENGTH)/1000000)) + ' J')
    print('        Sleep: ' + str(VOLTS*(model(SlotType.Sleep)/1000000)) + ' J')
    print('        TxDataRxAckMissing: ' + str(VOLTS*(model(SlotType.TxDataRxAckMissing, PACKET_LENGTH)/1000000)) + ' J')
